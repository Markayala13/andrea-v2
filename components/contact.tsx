      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          >
            ...
            <h3 className="font-serif text-lg mb-2">{t.contact.hours}</h3>
        ...
        >
          <div className="text-center mb-6">
            <h3 className="font-serif text-xl md:text-2xl font-light mb-2 tracking-wide">{t.contact.findUs}</h3>
            <p className="font-sans text-xs text-primary-foreground/60">{t.contact.findUsSubtitle}</p>
          </div>
